...
def getNome():
    ...
    """
    return "Luiz Augusto Simon Sabadini" 
...
def defe(tabuleiro, simboloComputador,x,y,z):
    ...
    """
    if tabuleiro[x] != simboloComputador and tabuleiro[x] != " " and tabuleiro[y] != simboloComputador and tabuleiro[y] != " " and tabuleiro[z] == " ":
        return True
    return False
...
def jogadaComputador(tabuleiro, simboloComputador):
    ...
    if tabuleiro[1] == simboloComputador and tabuleiro[2] == simboloComputador and tabuleiro[3] == " ":
        ...
        j=1
    elif tabuleiro[7] == simboloComputador and tabuleiro[1] == simboloComputador and tabuleiro[4] == " ":
        j=4
    elif tabuleiro[8] == simboloComputador and tabuleiro[5] == simboloComputador and tabuleiro[2] == " ":
        j=2
    elif tabuleiro[9] == simboloComputador and tabuleiro[3] == simboloComputador and tabuleiro[6] == " ":
        j=6
    elif tabuleiro[7] == simboloComputador and tabuleiro[5] == simboloComputador and tabuleiro[3] == " ":
        j=3
    ...
    # Combinações para se defender
        ...
        return 5
    elif defe(tabuleiro,simboloComputador,7,3,8) or defe(tabuleiro,simboloComputador,9,1,8):
        return 8
    elif defe(tabuleiro,simboloComputador,7,5,3):
        return 3
    elif defe(tabuleiro,simboloComputador,7,4,1):
        return 1
    elif tabuleiro[1] == simboloComputador and tabuleiro[8] == simboloComputador and tabuleiro[9] == " ":
        j=9
    elif tabuleiro[3] == simboloComputador and tabuleiro[8] == simboloComputador and tabuleiro[7] == " ":
        j=7
    elif tabuleiro[9] == simboloComputador and tabuleiro[2] == simboloComputador and tabuleiro[1] == " ":
        j=1
    elif tabuleiro[7] == simboloComputador and tabuleiro[2] == simboloComputador and tabuleiro[3] == " ":
        j=3
    elif tabuleiro[6] != simboloComputador and tabuleiro[6] != " " and defe(tabuleiro,simboloComputador,8,2,9):
        return 9

    elif tabuleiro[1] == simboloComputador and tabuleiro[3] == simboloComputador and tabuleiro[5] == " ":
        j=5
    elif tabuleiro[1] == simboloComputador and tabuleiro[2] != simboloComputador and tabuleiro[2] != " " and tabuleiro[4] == " ":
        j=4
    elif tabuleiro[1] == simboloComputador and tabuleiro[5] != simboloComputador and tabuleiro[5] != " " and tabuleiro[9] == " ":
        j=9
    elif tabuleiro[1] == simboloComputador and tabuleiro[7] != simboloComputador and tabuleiro[7] != " " and tabuleiro[9] == " ":
        j=9
    elif tabuleiro[8] != simboloComputador and tabuleiro[8] != " " and tabuleiro[3] != simboloComputador and tabuleiro[3] != " " and tabuleiro[9] == " ":
        j=9
    
    elif tabuleiro[6] != simboloComputador and tabuleiro[6] != " " and tabuleiro[2] != simboloComputador and tabuleiro[2] != " " and tabuleiro[3] == simboloComputador and tabuleiro[5] == " ":
        j=5
    elif tabuleiro[8] != simboloComputador and tabuleiro[8] != " " and tabuleiro[6] != simboloComputador and tabuleiro[6] != " " and tabuleiro[3] == " ":
        j=3
    elif tabuleiro[8] != simboloComputador and tabuleiro[8] != " " and tabuleiro[4] != simboloComputador and tabuleiro[4] != " " and tabuleiro[1] == " ":
        j=7
    elif tabuleiro[2] != simboloComputador and tabuleiro[2] != " " and tabuleiro[6] != simboloComputador and tabuleiro[6] != " " and tabuleiro[3] == " ":
        j=3
    elif tabuleiro[2] != simboloComputador and tabuleiro[2] != " " and tabuleiro[4] != simboloComputador and tabuleiro[4] != " " and tabuleiro[1] == " ":
        j=1
    elif tabuleiro[1] != simboloComputador and tabuleiro[1] != " " and tabuleiro[8] != simboloComputador and tabuleiro[8] != " " and tabuleiro[7] == " ":
        j=7

    elif tabuleiro[1] != simboloComputador and tabuleiro[1] != " " and tabuleiro[5] == " ":
        j=5
    elif tabuleiro[3] != simboloComputador and tabuleiro[3] != " " and tabuleiro[5] == " ":
        j=5
    elif tabuleiro[7] != simboloComputador and tabuleiro[7] != " " and tabuleiro[5] == " ":
        j=5
    elif tabuleiro[9] != simboloComputador and tabuleiro[9] != " " and tabuleiro[5] == " ":
        j=5
    elif tabuleiro[6] != simboloComputador and tabuleiro[6] != " " and tabuleiro[3] == " ":
        j=3

    elif tabuleiro[8] != simboloComputador and tabuleiro[8] != " " and tabuleiro[7] == " ":
        j=7
    elif tabuleiro[5] != simboloComputador and tabuleiro[5] != " " and tabuleiro[9] != simboloComputador and tabuleiro[9] != " " and tabuleiro[3] == " ":
        j=3
    
    elif tabuleiro[5] != simboloComputador and tabuleiro[5] != " " and tabuleiro[6] != simboloComputador and tabuleiro[6] != " " and tabuleiro[4] != simboloComputador and tabuleiro[4] != " " and tabuleiro[2] == " ":
        j=2
...
def verificaJogada(tabuleiro,simbolo,simboloComputador):
    ...
    """
    if verificaVencedor(simbolo, simboloComputador, tabuleiro[3], tabuleiro[5], tabuleiro[7]) == simbolo or verificaVencedor(simbolo, simboloComputador, tabuleiro[1], tabuleiro[5], tabuleiro[9]) == simbolo or verificaVencedor(simbolo, simboloComputador, tabuleiro[1], tabuleiro[2], tabuleiro[3]) == simbolo or verificaVencedor(simbolo, simboloComputador, tabuleiro[4], tabuleiro[5], tabuleiro[6]) == simbolo or verificaVencedor(simbolo, simboloComputador, tabuleiro[7], tabuleiro[8], tabuleiro[9]) == simbolo or verificaVencedor(simbolo, simboloComputador, tabuleiro[1], tabuleiro[4], tabuleiro[7]) == simbolo or verificaVencedor(simbolo, simboloComputador, tabuleiro[2], tabuleiro[5], tabuleiro[8]) == simbolo or verificaVencedor(simbolo, simboloComputador, tabuleiro[3], tabuleiro[6], tabuleiro[9]) == simbolo:
        limpaTela()
        imprimetabuleiro(tabuleiro)
        print(f"Parabéns! Você venceu a partida!")
        escolha = input("Que ótima jogada, meu caro!! Gostaria de jogar novamente? (Digite 'S' para continuar ou qualquer outra tecla para finalizar): ")
        if escolha == "S" or escolha == "s":
            programa()
        else:
            quit()
    elif verificaVencedor(simbolo, simboloComputador, tabuleiro[3], tabuleiro[5], tabuleiro[7]) == simboloComputador or verificaVencedor(simbolo, simboloComputador, tabuleiro[1], tabuleiro[5], tabuleiro[9]) == simboloComputador or verificaVencedor(simbolo, simboloComputador, tabuleiro[1], tabuleiro[2], tabuleiro[3]) == simboloComputador or verificaVencedor(simbolo, simboloComputador, tabuleiro[4], tabuleiro[5], tabuleiro[6]) == simboloComputador or verificaVencedor(simbolo, simboloComputador, tabuleiro[7], tabuleiro[8], tabuleiro[9]) == simboloComputador or verificaVencedor(simbolo, simboloComputador, tabuleiro[1], tabuleiro[4], tabuleiro[7]) == simboloComputador or verificaVencedor(simbolo, simboloComputador, tabuleiro[2], tabuleiro[5], tabuleiro[8]) == simboloComputador or verificaVencedor(simbolo, simboloComputador, tabuleiro[3], tabuleiro[6], tabuleiro[9]) == simboloComputador:
        limpaTela()
        imprimetabuleiro(tabuleiro)
        print(f"Que pena! O computador venceu a partida!")
        escolha = input("Às vezes a vida é deveras complexa, meu bom. Gostaria de uma revanche? (Digite 'S' para continuar ou qualquer outra tecla para finalizar): ")
        if escolha == "S" or escolha == "s":
            programa()
        else:
            quit()
        ...
        imprimetabuleiro(tabuleiro)
        print("Empate!")
        escolha = input("Gostaria desempatar esse negócio e deixar clara a sua superioridade? (Digite 'S' para continuar ou qualquer outra tecla para finalizar): ")
        if escolha == "S" or escolha == "s":
            programa()
        else:
            quit()
...
def posiçao(tabuleiro):
    ...
    if posiçaoo != "1" and posiçaoo != "2" and posiçaoo != "3" and posiçaoo != "4" and posiçaoo != "5" and posiçaoo != "6" and posiçaoo != "7" and posiçaoo != "8" and posiçaoo != "9":
